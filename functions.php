...
function foundation_assets() {
	...
	if (!is_admin()) {
		...
		wp_enqueue_script( 'shim', get_template_directory_uri() . '/js/jquery.html5-placeholder-shim.js', null, '4.0', true );
		wp_enqueue_script( 'weather', get_template_directory_uri() . '/js/simpleWeather.js', null, '4.0', true );
		wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/vendor/jquery.js', null, '4.0', true );
		wp_enqueue_script( 'scripts', get_template_directory_uri() . '/js/scripts.js', null, '4.0', true );
...
function foundation_widgets() {
	...
	register_sidebar( array(
			...
			'name' => __( 'Useful Links', 'foundation' ),
